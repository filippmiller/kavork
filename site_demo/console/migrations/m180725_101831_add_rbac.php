...
/**
 * Class m180725_101831_add_rbac
 */
class m180725_101831_add_rbac extends Migration
{
  /**
  ...
  public function safeUp()
  {
    ...
    $this->createTable($authManager->itemChildTable, [
        ...
        'sort_index'=>$this->integer()->null()->defaultValue(0),
  ...
  {
    echo "m180725_101831_add_rbac cannot be reverted.\n";
    $authManager = $this->getAuthManager();
    $this->db = $authManager->db;
