...
<div class="news-index">
  ...
  <div class="col-md-6 text-right">
    <?= Html::a('<span class="fa fa-plus"></span> ' .Yii::t('db_rbac', 'Добавить роль'), ['add-role'], ['class' => 'btn btn-success']) ?>
  </div>
   </div>
  <?php
              ...
              'buttons' =>
                  [
                      'update' => function ($url, $model) {
                        return Html::a('<div class="btn btn-info"><span class="fa fa-pencil"></span></div>', Url::toRoute(['update-role', 'name' => $model->name]), [
                            'title' => Yii::t('yii', 'Update'),
                            'data-pjax' => '0',
                        ]);
                      },
                      'delete' => function ($url, $model) {
                        return Html::a('<div class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></div>', Url::toRoute(['delete-role', 'name' => $model->name]), [
