...
$(function() {
	"use strict"; 
  // ïðè íàæàòèè íà êíîïêó scrollup
  $('.scrollup').click(function() {
    // ïåðåìåñòèòüñÿ â âåðõíþþ ÷àñòü ñòðàíèöû
    $("html, body").animate({
      scrollTop:0
    },600);
  })
})
// ïðè ïðîêðóòêå îêíà (window)
$(window).scroll(function() {
  // åñëè ïîëüçîâàòåëü ïðîêðóòèë ñòðàíèöó áîëåå ÷åì íà 200px
  if ($(this).scrollTop()>200) {
    // òî ñäåëàòü êíîïêó scrollup âèäèìîé
    $('.scrollup').fadeIn();
  }
  // èíà÷å ñêðûòü êíîïêó scrollup
  else {
    $('.scrollup').fadeOut();
  }
});
$( '#mNavbar .navbar-nav a' ).on( 'click', function () {
    ...
    '[data-toggle="mod"]', // òóò ïðîïèñûâàåì ñåëåêòîð, êîòîðûé äîáàâëÿåì ê òåì .dropdown-menu, êîòîðûå íå äîëæíà çàêðûâàòüñÿ ïî êëèêó íà âíóòðåííèõ ýëåìåíòàõ
