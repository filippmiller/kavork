...
$cost =
    !$model->getIsUniteMaster()?
        $model->getLastPay():
        $model->unite_cost-$model->unite_prepay;
...
$banknotes = [];
if (!empty($model->cafe->param->banknote_list)) {
	$banknotes = explode(',', $model->cafe->param->banknote_list);
...
?>
	<?php if (!empty($banknotes)): ?>
		<div class="input-group-btn dropup">
			...
			<ul class="dropdown-menu dropdown-science-blue pull-right __use_banknote__" role="menu">
...
<h5 class="vid_check padding-top-10">
  ...
  <span
      class="__surrender_amount__ font-weight-700 font-size-20"
