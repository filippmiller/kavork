	...
	<div id="ajaxCrudDatatable">
        <?=GridView::widget([
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' .($canCreate?Html::a('<i class="fa fa-user-plus "></i> '.Yii::t('app', 'Create new Users').'', ['create'],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new Users'),'class'=>'btn btn-science-blue']):''). '
		     ' . $panelButtons . '
		     </div>
