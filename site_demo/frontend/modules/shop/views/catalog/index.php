...
/* @var $searchModel frontend\modules\shop\models\ShopProductSearch */
      ...
      //'export' => false,
        ...
        'panelBeforeTemplate' => '<div class="row">
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' . ($canCreate ? Html::a('<i class="fa fa-plus"></i> <i class="icon-metro-box"></i> ' . Yii::t('app', 'Create new Shop Products') . '', ['create'],
