...
/* @var $searchModel frontend\modules\shop\models\ShopSupplierSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Shop Suppliers');
      ...
      //'export' => false,
        ...
        'panelBeforeTemplate' => '<div class="row">
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' . ($canCreate ? Html::a('<i class="fa fa-plus"></i> <i class="fa fa-truck"></i> ' . Yii::t('app', 'Create new Shop Suppliers') . '', ['create'],
                ['role' => 'modal-remote', 'title' => Yii::t('app', 'Create new Shop Suppliers'), 'class' => 'btn btn-science-blue']) : '') . '
		     ' . $panelButtons . '
		     </div>
