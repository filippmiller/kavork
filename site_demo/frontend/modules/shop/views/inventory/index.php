...
$this->title = Yii::t('main', 'INVENTORY');
...
<?= $this->render($is_shop ? '../_partials/menu_shop' : '../_partials/menu'); ?>
  ...
  <div id="ajaxCrudDatatable">
    <?= GridView::widget([
      ...
      //'export' => false,
        ...
        'toolbar' => [
            ['content' =>
                Html::a('<i class="fa fa-refresh"></i> ' . Yii::t('app', 'Reset') . '', [($is_shop ? "shop" : "")],
                    ['data-pjax' => 1, 'class' => 'btn btn-default', 'title' => Yii::t('app', 'Reset Grid')]) .

                Html::a('<i class="fa fa-th-list"></i> ' . Yii::t('app', 'Columns') . '', ['columns' . ($is_shop ? "_shop" : "")],
        ...
        'panelBeforeTemplate' => '<div class="row">
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' . ($canCreate ? Html::a('<i class="fa fa-plus"></i> <i class="icon-metro-box"></i> ' . Yii::t('app', 'Create new Shop Products') . '', '/shop/catalog/create'.($is_shop?'?is_shop=1':''),
                ['role' => 'modal-remote', 'title' => Yii::t('app', 'Create new Shop Products'), 'class' => 'btn btn-science-blue']) : '') . '
		     ' . $panelButtons . '
		     </div>
