...
/* @var $searchModel frontend\modules\shop\models\ShopSaleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Shop Sales');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="shop-sale-index">
  <div id="ajaxCrudDatatable">
    <?= GridView::widget([
        ...
        'pjaxSettings' => [
            'neverTimeout' => true,
            'beforeGrid' => $this->render('../_partials/menu_shop'),
        ],
        'striped' => true,
        'condensed' => true,
        'responsive' => true,
