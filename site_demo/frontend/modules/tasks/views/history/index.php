...
/* @var $searchModel frontend\modules\tasks\models\DoTaskSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'DoTask list');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);
$zadachi = Html::a(
         '<i class="fa fa-angle-double-left"></i> '. Yii::t('app', 'Task list') .'',
        ['/tasks/admin/index'],
        ['data-pjax' => 0,'class' => 'btn btn-science-blue margin-right-10'])
?>
<div class="do-task-index">
   <div id="ajaxCrudDatatable">
        <?=GridView::widget([
			...
			'toolbar'=> [
			 ...
			 'panelBeforeTemplate' => 
			'<div class="row"><div class="col-sm-4 padding-off-right vertical-align">
		    ' . GridPageSize::widget() . ' {summary}
		     </div>
		     <div class="col-sm-4 mass_but">
		     ' . $panelButtons . ''. $zadachi .'
		     </div>
