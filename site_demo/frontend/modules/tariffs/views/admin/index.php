...
/* @var $searchModel frontend\modules\tariffs\models\TariffsSearch */
	 ...
	 <div id="ajaxCrudDatatable">
        <?=GridView::widget([
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' .($canCreate?Html::a('<i class="fa fa-plus"></i> <i class="fa fa-sliders"></i> '.Yii::t('app', 'Create new Tariffs').'', ['create'],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new Tariffs'),'class'=>'btn btn-science-blue']):''). '
		     ' . $panelButtons . '
		     </div>
