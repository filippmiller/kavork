...
/* @var $searchModel frontend\modules\templates\models\TemplateSearch */
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' .($canCreate?Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Create new Templates').'', ['create'],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new Templates'),'class'=>'btn btn-science-blue']):''). '
		     ' . $panelButtons . '
		     </div>
