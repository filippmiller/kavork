...
/* @var $searchModel frontend\modules\franchisee\models\FranchiseeTariffsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Franchisee Tariffs');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="franchisee-tariffs-index">
      ...
      //'export' => false,
        ...
        'panelBeforeTemplate' => '<div class="row">
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' . ($canCreate ? Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Create new Franchisee Tariffs') . '', ['create'],
                ['role' => 'modal-remote', 'title' => Yii::t('app', 'Create new Franchisee Tariffs'), 'class' => 'btn btn-science-blue']) : '') . '
		     ' . $panelButtons . '
		     </div>
