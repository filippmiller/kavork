...
/* @var $searchModel frontend\modules\franchisee\models\FranchiseeSearch */
      ...
      //'export' => false,
        ...
        'panelBeforeTemplate' => '<div class="row">
		    ...
		    ' . GridPageSize::widget() . ' {summary}
		     ...
		     ' . ($canCreate ? Html::a('<i class="fa fa-plus"></i> <i class="fa fa-cubes"></i> ' . Yii::t('app', 'Create new Franchisees') . '', ['create'],
                ['role' => 'modal-remote', 'title' => Yii::t('app', 'Create new Franchisees'), 'class' => 'btn btn-science-blue']) : '') . '
		     ' . $panelButtons . '
		     </div>
