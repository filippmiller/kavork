...
editor = function () {
  ...
  function generateBlock(item, tag, datas, sub_tag) {
    ...
    item.find('.col-empty').attr('empty_msg', "");
  ...
  function create_block(type, data, sub_type) {
    ...
    out = "<div class=li_wrap type='" + (type == "row" ? app.i18n.row : app.i18n.content) + "'>" +
      out +
  ...
  function get_options(tag, el, set_def, sub_tag) {
    ...
    for (var i = 0; i < tag_params.length; i++) {
      ...
      out += "<div class='text-center'><h6 class='font-weight-600 margin-off-bottom desire_h6'>" + title + "</h6><hr class='hrmin_new'></div>";
      for (var j = 0; j < tag_params[i].items.length; j++) {
        ...
        if (tag_params[i].items[j].isLanguage) {
          out += "<label class='isLanguage'><span>" + title + "</span></label>";
        } else {
          out += "<div class='col-md-6 padding-off-left desire_label'><label>" + title + "</label></div>";
        }
        if (type == "text") {
          out += '<input class="form-control" name="' + name + '" value="' + value + '">';
        }
        if (type == "number") {
          out += '<div class="col-md-6 padding-off-left input-group desire_input"><input name="' + name + '" class="num form-control" value="' + value + '"><span class="input-group-addon">px</span></div>';
        }
        if (type == "color") {
          out += '<div class="col-md-6 padding-off-left padding-off-right desire_input"><input class="form-control" name="' + name + '" type=color value="' + value + '"></div>';
        }
        if (type == "font") {
          list = ['Arial', 'Verdana', 'Times New Roman', 'Georgia', 'Verdana', 'Courier New', 'Lucida Console', 'Roboto Mono,monospace'];
          type = "select";
        }
        if (type == "align") {
          list = align_list;
        ...
        if (type == "select") {
          out += '<div class="col-md-6 padding-off-left padding-off-right desire_input"><select class="form-control" name="' + name + '">';
  ...
  function setData(data) {
    ...
    if (!template.ready() || typeof(app.ckeditor_init) == "undefined") {
      setTimeout(setData, 100, data);
      return;
    }
  ...
  CKEDITOR.config.format_h1 = {
    ...
    attributes: {
      'class': 'h1',
      'style': 'font-size: 48px; margin-bottom: 12px;margin-top: 23px;font-weight: 300;line-height: 1.1;'
    }
  };
  CKEDITOR.config.format_h2 = {
    ...
    attributes: {
      'class': 'h2',
      'style': 'font-size: 40px; margin-bottom: 12px;margin-top: 23px;font-weight: 300;line-height: 1.1;'
    }
  };
  CKEDITOR.config.format_h3 = {
    ...
    attributes: {
      'class': 'h3',
      'style': 'font-size: 34px; margin-bottom: 12px;margin-top: 23px;font-weight: 300;line-height: 1.1;'
    }
  };
  CKEDITOR.config.format_h4 = {
    ...
    attributes: {
      'class': 'h4',
      'style': 'font-size: 24px; margin-top: 12px;margin-bottom: 8px;font-weight: 300;line-height: 1.1;'
    }
  };
  CKEDITOR.config.format_h5 = {
    ...
    attributes: {
      'class': 'h5',
      'style': 'font-size: 20px; margin-top: 12px;margin-bottom: 8px;font-weight: 300;line-height: 1.1;'
    }
  };
  CKEDITOR.config.format_h6 = {
    ...
    attributes: {
      'class': 'h6',
      'style': 'font-size: 16px; margin-top: 12px;margin-bottom: 8px;font-weight: 300;line-height: 1.1;'
    }
  };
  CKEDITOR.config.format_tags = "p;h1;h2;h3;h4;h5;h6;div";

  CKEDITOR.config.font_names += '; FONT FOR CHECK/ Roboto Mono, monospace';
