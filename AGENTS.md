...
- Primary docs live in C:\\Dev\\_OpsVault\\kavork\\Docs.
- Session notes/logs must be written to C:\\Dev\\_OpsVault\\kavork\\Sessions.
- Secrets and .env files live in C:\\Dev\\_OpsVault\\kavork\\Secrets (never in repo).
